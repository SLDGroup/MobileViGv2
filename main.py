...
from util import *
from models import *
from models.mobilevigv2 import reparameterize_model


def get_args_parser():
    parser = argparse.ArgumentParser(
        'MobileViGv2 training and evaluation script', add_help=False)
    ...
    # Model parameters
    parser.add_argument('--model', default='mobilevigv2_ti', type=str, metavar='MODEL',
...
def main(args):
    ...
    # wrap the train_loss in our custom DistillationLoss, which
    # just dispatches to the original train_loss if args.distillation_type is
    # 'none'
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        'MobileViG training and evaluation script', parents=[get_args_parser()])
