...
@register_model
def mobilevigv2_ti(pretrained=False, **kwargs):
    model = MobileViG(blocks=[[2,0], [2,2], [6,2], [2,2]],
...
@register_model
def mobilevigv2_s(pretrained=False, **kwargs):
...
@register_model
def mobilevigv2_m(pretrained=False, **kwargs):
    model = MobileViG(blocks=[[3,0], [3,3], [9,3], [3,3]],
...
@register_model
def mobilevigv2_b(pretrained=False, **kwargs):
    model = MobileViG(blocks=[[3,0], [3,3], [9,3], [3,3]],
